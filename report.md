...
- `test_cccd_detected` — ✅ Pass
- `test_phone_detected` — ✅ Pass
- `test_email_detected` — ✅ Pass
- `test_detection_rate_above_95_percent` — ✅ Pass (≥ 95%)
- `test_pii_not_in_output` — ✅ Pass
- `test_non_pii_columns_unchanged` — ✅ Pass
